...
**目前進度**：Phase 0 + Phase 1（LVM striping CLI 工具）已完成，Phase 2（Weighted I/O Scheduler）已實作原型。
...
| `src/tiered_io.c` | CLI I/O 工具：info/read/write/bench/bench-all/path/BLKDISCARD，呼叫 tv_write/tv_read 驗證 scheduler | 640 |
